...
const updateBooking = catchAsync(async (req: Request, res: Response) => {
    const booking: IBooking = await bookingService.updateBooking(Number(req.params.id), req.body);
    sendResponse<IBooking>(res, {
...
const traineesBookings = catchAsync(async (req: Request, res: Response) => {
    const bookings: IBooking[] = await bookingService.traineesBookings(Number(req.params.id));
